...
//    }
    ...
    public static String inferEndpoint() {
        final String possibleValue = JenkinsUtils.retrieveExternalValue(JenkinsConstants.ENDPOINT_SYSTEM_PROPERTY, JenkinsConstants.ENDPOINT_ENVIRONMENT_VARIABLE);
        return possibleValue != null ? possibleValue : JenkinsConstants.DEFAULT_ENDPOINT;
    }
    ...
    public static JenkinsAuthentication inferAuthentication() {
        ...
        String authValue = JenkinsUtils.retrieveExternalValue(JenkinsConstants.API_TOKEN_SYSTEM_PROPERTY, JenkinsConstants.API_TOKEN_ENVIRONMENT_VARIABLE);
        if (authValue != null) {
        ...
        authValue = JenkinsUtils.retrieveExternalValue(JenkinsConstants.CREDENTIALS_SYSTEM_PROPERTY, JenkinsConstants.CREDENTIALS_ENVIRONMENT_VARIABLE);
        if (authValue != null) {
